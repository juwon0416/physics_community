...
import { createConceptNode, createOrUpdateSection, createOrUpdateTopic, deleteGraphEdge, getGraphSnapshot, getSectionsByTopic, getTopicBySlug, listTopics, upsertGraphEdge, writeTopicDraft, } from './repository.js';
...
server.registerTool('upsert_topic', {
...
server.registerTool('write_topic_draft', {
...
server.registerTool('upsert_section', {
...
server.registerTool('create_concept_node', {
...
server.registerTool('upsert_graph_edge', {
...
server.registerTool('delete_graph_edge', {
...
server.registerResource('graph-overview', 'physics://graph/overview', {
...
server.registerPrompt('author_topic', {
    title: 'Author topic',
    ...
    messages: [
        {
            ...
            content: {
                type: 'text',
                text: `Open the topic "${slug}", review its current content and sections, then help author the page for this goal: ${writingGoal}. ` +

...
export default function Network3DView({ model, focusedNodeId, onNodeSelect }: Network3DViewProps) {
    ...
    useEffect(() => {
        ...
        if (fg) {
            try {
                // 모바일 기기에서의 과도한 해상도(3x)로 인한 WebGL Context 튕김/메모리 부족 방지
                ...
                console.warn("Could not set pixel ratio on renderer", e);
            }

...
| --- | --- | --- | --- | --- |
| in | migrates | [[database-clean-edges]] | medium | migration @ database/sql/maintenance/clean_edges.sql |
| in | migrates | [[database-complete-graph-schema]] | medium | migration @ database/sql/schema/complete_graph_schema.sql |
| in | migrates | [[database-hierarchical-graph-schema]] | medium | migration @ database/sql/schema/hierarchical_graph_schema.sql |
